...
export const stylesMode = {
  ...
  main: '[data-mui-color-scheme="main"] &',
};
...
export function setFont(fontName: string) {
  return `"${fontName}",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","poppins"`;
}
